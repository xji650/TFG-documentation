...
\begin{itemize}
    ...
    \item \textbf{Quantificació de l'"Impost Arquitectònic":} S'ha mesurat el cost real de desplegar Kubernetes en dispositius limitats. K3s incrementa el consum de RAM en repòs un 16\% (\textasciitilde 120 MB addicionals), triplica el temps de recuperació local (1.473 ms vers 491 ms) i redueix l'amplada de banda efectiva un 30\% a causa de l'encapsulament de la seva xarxa virtual CNI (Flannel).
